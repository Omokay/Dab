    ...
    return (
        <div className='footer'>
            <div className='row footer-row'>
                <div className='columns col-md-4  col-sm-6'>
                ...
                <div className='columns col-md-4  col-sm-6'>
                    <h3>Contact us</h3>
                    <p><span><Phone />  </span>080-XXXX-XXXXX</p>
                    <p><span><Mail />  </span>info@dab.com</p>
                    <p><span><MapPin />  </span>No 1 Akin Lakanu Close Adeniyi Jones</p>
                </div>
            </div>
